            ...
            <form onSubmit={handleSubmit}>
                {
                    newUser === true && <>
                        ...
                        <input type="password" name="password" placeholder="Password" onBlur={handleBlur} required /> <br />
                        <input type="password" name="password2" placeholder="Confirm Password" onBlur={handleBlur} required /> <br />
